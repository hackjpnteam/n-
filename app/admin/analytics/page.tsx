    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="rounded-2xl shadow-lg bg-white mb-8">
        <div className="p-6 border-b">
          <h2 className="text-xl font-bold text-gray-900 mb-4">ランキング</h2>
        ...
        <div className="p-6">
          {activeTab === 'users' ? (
            <CompletionRateChart 
              data={data.userRanking?.map((user: any) => ({
                name: user.userName,
            ...
            <CompletionRateChart 
              data={data.progressStats?.map((stat: any) => ({
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="rounded-2xl shadow bg-white">
          <div className="p-6 border-b">
            <h3 className="text-lg font-bold text-gray-900">ユーザー進捗詳細</h3>
          </div>
          <div className="overflow-x-auto max-h-96">
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                {data.userRanking?.map((user: any, index: number) => (
        ...
        <div className="rounded-2xl shadow bg-white">
          <div className="p-6 border-b">
            <h3 className="text-lg font-bold text-gray-900">動画別進捗詳細</h3>
          </div>
          <div className="overflow-x-auto max-h-96">
            <table className="w-full">
              <thead className="bg-gray-50 sticky top-0">
              ...
              <tbody className="divide-y divide-gray-200">
                {data.progressStats.map((stat: any) => (
      ...
      <div className="rounded-2xl shadow bg-white">
        <div className="p-6 border-b">
          <h2 className="text-xl font-bold text-gray-900">クイズ統計</h2>
        </div>
